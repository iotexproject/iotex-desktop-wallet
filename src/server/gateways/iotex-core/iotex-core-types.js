...
import type {TCreateDeposit, TSettleDeposit} from '../../../entities/wallet-types';
...
export function fromGCreateDeposit(t: GCreateDeposit): TCreateDeposit {
  const {ID, blockID, ...other} = t;
  return {
    id: ID,
    blockId: blockID,
