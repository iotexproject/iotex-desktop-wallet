...
export class OnefxAuth {
  ...
  public async sendResetPasswordLink(userId: string, email: string, t: any) {
  ...
  public authRequired = async (ctx: any, next: any) => {
  ...
  public authOptionalContinue = async (ctx: any, next: any) => {
